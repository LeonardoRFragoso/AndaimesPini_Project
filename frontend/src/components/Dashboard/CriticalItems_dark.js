      ...
      >
        <Paper 
          ...
          sx={{ 
            ...
            p: 1.5, 
            borderRadius: 2,
            border: theme => `1px solid ${isRented 
              ? theme.palette.mode === 'dark' ? 'rgba(25, 118, 210, 0.3)' : 'rgba(25, 118, 210, 0.2)'
              : theme.palette.mode === 'dark' ? 'rgba(255, 82, 82, 0.3)' : 'rgba(255, 82, 82, 0.2)'}`,
            bgcolor: theme => isRented 
              ? theme.palette.mode === 'dark' ? 'rgba(25, 118, 210, 0.1)' : 'rgba(25, 118, 210, 0.05)'
              : theme.palette.mode === 'dark' ? 'rgba(255, 82, 82, 0.1)' : 'rgba(255, 82, 82, 0.05)',
      ...
      <Grid item xs={12} md={6}>
        ...
        >
          <Box sx={{ 
            ...
            borderRadius: '50%', 
            background: theme => theme.palette.mode === 'dark'
              ? 'radial-gradient(circle, rgba(244,67,54,0.15) 0%, rgba(0,0,0,0) 70%)'
              : 'radial-gradient(circle, rgba(244,67,54,0.1) 0%, rgba(255,255,255,0) 70%)',
            zIndex: 0 
          }} />
          ...
          <Box sx={{ position: 'relative', zIndex: 1 }}>
            <Box sx={{ 
              ...
              <Typography 
                ...
                sx={{ 
                  fontWeight: 600, 
                  color: theme => theme.palette.mode === 'dark' ? '#ff5252' : '#2c552d',
                  display: 'flex',
                  alignItems: 'center',
                  gap: 1
                }}
          ...
          <Box sx={{ position: 'relative', zIndex: 1 }}>
            <Box sx={{ 
              ...
              <Typography 
                ...
                sx={{ 
                  fontWeight: 600, 
                  color: theme => theme.palette.mode === 'dark' ? '#90caf9' : '#2c552d',
                  display: 'flex',
                  alignItems: 'center',
                  gap: 1
                }}
