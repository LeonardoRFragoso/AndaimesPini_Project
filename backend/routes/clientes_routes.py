...
def get_clientes():
    ...
    try:
        ...
        logger.error(f"Erro inesperado ao buscar clientes: {ex}")
...
def add_cliente():
    ...
    try:
        ...
        if cliente_id is None:
            logger.error("Erro ao adicionar o cliente.")
        ...
        logger.error(f"Erro inesperado ao adicionar cliente: {ex}")
...
def update_cliente(cliente_id):
    ...
    try:
        ...
        logger.error(f"Erro inesperado ao atualizar cliente: {ex}")
...
def delete_cliente(cliente_id):
    ...
    try:
        ...
        logger.error(f"Erro inesperado ao excluir cliente: {ex}")
